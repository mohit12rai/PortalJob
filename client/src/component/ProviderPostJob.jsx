  ...
  const applyFilters = () => {
    ...
    if (filters.skill) {
      filtered = filtered.filter((job) =>
        job.skill.toLowerCase().includes(filters.skill.toLowerCase())
      );
    }
          ...
          {jobs.map((job) => (
            ...
            >
              ...
              <p className="text-gray-600">
                <strong>Skills:</strong> {job.skill}
              </p>
              <p className="text-gray-600">
              ...
              <p className="text-gray-600">
                <strong>CTC:</strong> ₹{job.maxCTC?.toLocaleString()}
              </p>
              <p className="text-gray-600">
                <strong>Notice Period:</strong> {job.noticePeriod} days
              </p>
...
export default ProviderPostJob;
